/* Generated by Cython 0.19.2 on Wed Jan 15 11:24:41 2014 */
...
static char __pyx_k_22[] = "/home/wiecki/working/projects/hddm/src/wfpt.pyx";
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_sum_logp) private(__pyx_t_12, __pyx_t_10, __pyx_t_8, __pyx_t_9, __pyx_t_11) firstprivate(__pyx_t_1, __pyx_t_3) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
