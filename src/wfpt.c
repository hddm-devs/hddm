/* Generated by Cython 0.15.1 on Tue Dec 11 16:05:01 2012 */
...
/* "/home/isofer/python/hddm/src/pdf.pxi":98
...
static char __pyx_k_19[] = "wiener_like_contaminant";
...
/* "/home/isofer/python/hddm/src/pdf.pxi":25
 *     double M_PI
 * 
...
static double __pyx_f_4wfpt_ftt_01w(double __pyx_v_tt, double __pyx_v_w, double __pyx_v_err) {
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":33
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":34
 *     # calculate number of terms needed for large t
 *     if M_PI*tt*err<1: # if error threshold is set low enough
 *         kl=sqrt(-2*log(M_PI*tt*err)/(M_PI**2*tt)) # bound             # <<<<<<<<<<<<<<
 *         kl=fmax(kl,1./(M_PI*sqrt(tt))) # ensure boundary conditions met
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":35
 *     if M_PI*tt*err<1: # if error threshold is set low enough
 *         kl=sqrt(-2*log(M_PI*tt*err)/(M_PI**2*tt)) # bound
 *         kl=fmax(kl,1./(M_PI*sqrt(tt))) # ensure boundary conditions met             # <<<<<<<<<<<<<<
 *     else: # if error threshold set too high
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":37
 *         kl=fmax(kl,1./(M_PI*sqrt(tt))) # ensure boundary conditions met
 *     else: # if error threshold set too high
 *         kl=1./(M_PI*sqrt(tt)) # set to boundary condition             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":40
 * 
 *     # calculate number of terms needed for small t
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":41
 *     # calculate number of terms needed for small t
 *     if 2*sqrt(2*M_PI*tt)*err<1: # if error threshold is set low enough
 *         ks=2+sqrt(-2*tt*log(2*sqrt(2*M_PI*tt)*err)) # bound             # <<<<<<<<<<<<<<
 *         ks=fmax(ks,sqrt(tt)+1) # ensure boundary conditions are met
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":42
 *     if 2*sqrt(2*M_PI*tt)*err<1: # if error threshold is set low enough
 *         ks=2+sqrt(-2*tt*log(2*sqrt(2*M_PI*tt)*err)) # bound
 *         ks=fmax(ks,sqrt(tt)+1) # ensure boundary conditions are met             # <<<<<<<<<<<<<<
 *     else: # if error threshold was set too high
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":44
 *         ks=fmax(ks,sqrt(tt)+1) # ensure boundary conditions are met
 *     else: # if error threshold was set too high
 *         ks=2 # minimal kappa for that case             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":47
 * 
 *     # compute f(tt|0,1,w)
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":48
 *     # compute f(tt|0,1,w)
 *     p=0 #initialize density
 *     if ks<kl: # if small t is better (i.e., lambda<0)             # <<<<<<<<<<<<<<
 *         K=<int>(ceil(ks)) # round to smallest integer meeting error
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":49
 *     p=0 #initialize density
 *     if ks<kl: # if small t is better (i.e., lambda<0)
 *         K=<int>(ceil(ks)) # round to smallest integer meeting error             # <<<<<<<<<<<<<<
 *         lower = <int>(-floor((K-1)/2.))
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":50
 *     if ks<kl: # if small t is better (i.e., lambda<0)
 *         K=<int>(ceil(ks)) # round to smallest integer meeting error
 *         lower = <int>(-floor((K-1)/2.))             # <<<<<<<<<<<<<<
 *         upper = <int>(ceil((K-1)/2.))
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":51
 *         K=<int>(ceil(ks)) # round to smallest integer meeting error
 *         lower = <int>(-floor((K-1)/2.))
 *         upper = <int>(ceil((K-1)/2.))             # <<<<<<<<<<<<<<
 *         for k from lower <= k <= upper: # loop over k
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":52
 *         lower = <int>(-floor((K-1)/2.))
 *         upper = <int>(ceil((K-1)/2.))
 *         for k from lower <= k <= upper: # loop over k             # <<<<<<<<<<<<<<
 *             p+=(w+2*k)*exp(-(pow((w+2*k),2))/2/tt) # increment sum
 ...
 */
    ...
    for (__pyx_v_k = __pyx_v_lower; __pyx_v_k <= __pyx_t_2; __pyx_v_k++) {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":53
 *         upper = <int>(ceil((K-1)/2.))
 *         for k from lower <= k <= upper: # loop over k
 *             p+=(w+2*k)*exp(-(pow((w+2*k),2))/2/tt) # increment sum             # <<<<<<<<<<<<<<
 *         p/=sqrt(2*M_PI*pow(tt,3)) # add con_stant term
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":54
 *         for k from lower <= k <= upper: # loop over k
 *             p+=(w+2*k)*exp(-(pow((w+2*k),2))/2/tt) # increment sum
 *         p/=sqrt(2*M_PI*pow(tt,3)) # add con_stant term             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":57
 * 
 *     else: # if large t is better...
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":58
 *     else: # if large t is better...
 *         K=<int>(ceil(kl)) # round to smallest integer meeting error
 *         for k from 1 <= k <= K:             # <<<<<<<<<<<<<<
 *             p+=k*exp(-(pow(k,2))*(M_PI**2)*tt/2)*sin(k*M_PI*w) # increment sum
 ...
 */
    ...
    for (__pyx_v_k = 1; __pyx_v_k <= __pyx_t_2; __pyx_v_k++) {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":59
 *         K=<int>(ceil(kl)) # round to smallest integer meeting error
 *         for k from 1 <= k <= K:
 *             p+=k*exp(-(pow(k,2))*(M_PI**2)*tt/2)*sin(k*M_PI*w) # increment sum             # <<<<<<<<<<<<<<
 *         p*=M_PI # add con_stant term
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":60
 *         for k from 1 <= k <= K:
 *             p+=k*exp(-(pow(k,2))*(M_PI**2)*tt/2)*sin(k*M_PI*w) # increment sum
 *         p*=M_PI # add con_stant term             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":62
 *         p*=M_PI # add con_stant term
 * 
 *     return p             # <<<<<<<<<<<<<<
 * 
...
/* "/home/isofer/python/hddm/src/pdf.pxi":64
 *     return p
 * 
 * cdef inline double prob_ub(double v, double a, double z) nogil:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE double __pyx_f_4wfpt_prob_ub(double __pyx_v_v, double __pyx_v_a, double __pyx_v_z) {
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":66
 * cdef inline double prob_ub(double v, double a, double z) nogil:
 *     """Probability of hitting upper boundary."""
 *     return (exp(-2*a*z*v) - 1) / (exp(-2*a*v) - 1)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/isofer/python/hddm/src/pdf.pxi":68
 *     return (exp(-2*a*z*v) - 1) / (exp(-2*a*v) - 1)
 * 
 * cdef double pdf(double x, double v, double a, double w, double err) nogil:             # <<<<<<<<<<<<<<
...
static double __pyx_f_4wfpt_pdf(double __pyx_v_x, double __pyx_v_v, double __pyx_v_a, double __pyx_v_w, double __pyx_v_err) {
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":72
 *     and implementation of Navarro & Fuss, 2009.
 *     """
 *     if x <= 0:             # <<<<<<<<<<<<<<
 *         return 0
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":73
 *     """
 *     if x <= 0:
 *         return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":75
 *         return 0
 * 
 *     cdef double tt = x/a**2 # use normalized time             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":76
 * 
 *     cdef double tt = x/a**2 # use normalized time
 *     cdef double p = ftt_01w(tt, w, err) #get f(t|0,1,w)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":79
 * 
 *     # convert to f(t|v,a,w)
...
/* "/home/isofer/python/hddm/src/pdf.pxi":81
 *     return p*exp(-v*a*w -(pow(v,2))*x/2.)/(pow(a,2))
 * 
 * cdef double pdf_sv(double x, double v, double sv, double a, double z, double err) nogil:             # <<<<<<<<<<<<<<
...
static double __pyx_f_4wfpt_pdf_sv(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_err) {
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":86
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":87
 *     """
 *     if x <= 0:
 *         return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":89
 *         return 0
 * 
 *     if sv==0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":90
 * 
 *     if sv==0:
 *         return pdf(x, v, a, z, err)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":92
 *         return pdf(x, v, a, z, err)
 * 
 *     cdef double tt = x/(pow(a,2)) # use normalized time             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":93
 * 
 *     cdef double tt = x/(pow(a,2)) # use normalized time
 *     cdef double p  = ftt_01w(tt, z, err) #get f(t|0,1,w)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":96
 * 
 *     # convert to f(t|v,a,w)
 *     return exp(log(p) + ((a*z*sv)**2 - 2*a*v*z - (v**2)*x)/(2*(sv**2)*x+2))/sqrt((sv**2)*x+1)/(a**2)             # <<<<<<<<<<<<<<
 * 
...
static double __pyx_f_4wfpt_full_pdf(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_sz, double __pyx_v_t, double __pyx_v_st, double __pyx_v_err, int __pyx_skip_dispatch, struct __pyx_opt_args_4wfpt_full_pdf *__pyx_optional_args) {
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":101
 *                       z, double sz, double t, double st, double err, int
 *                       n_st=2, int n_sz=2, bint use_adaptive=1, double
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":105
 * 
    ...
    if (!__pyx_t_2) {
      ...
      if (!__pyx_t_3) {
        ...
        if (!__pyx_t_4) {
          ...
          if (!__pyx_t_5) {
            __pyx_t_6 = (__pyx_v_sv < 0.0);
            if (!__pyx_t_6) {
              __pyx_t_7 = (__pyx_v_sz < 0.0);
              if (!__pyx_t_7) {
                __pyx_t_8 = (__pyx_v_sz > 1.0);
                if (!__pyx_t_8) {

                  /* "/home/isofer/python/hddm/src/pdf.pxi":106
 *     # Check if parpameters are valid
 *     if (z<0) or (z>1) or (a<0) or (t<0) or (st<0) or (sv<0) or (sz<0) or (sz>1) or \
 *        ((fabs(x)-(t-st/2.))<0) or (z+sz/2.>1) or (z-sz/2.<0) or (t-st/2.<0):             # <<<<<<<<<<<<<<
 *         return 0
 * 
 */
                  __pyx_t_9 = ((fabs(__pyx_v_x) - (__pyx_v_t - (__pyx_v_st / 2.))) < 0.0);
                  if (!__pyx_t_9) {
                    __pyx_t_10 = ((__pyx_v_z + (__pyx_v_sz / 2.)) > 1.0);
                    if (!__pyx_t_10) {
                      __pyx_t_11 = ((__pyx_v_z - (__pyx_v_sz / 2.)) < 0.0);
                      if (!__pyx_t_11) {
                        __pyx_t_12 = ((__pyx_v_t - (__pyx_v_st / 2.)) < 0.0);
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":107
 *     if (z<0) or (z>1) or (a<0) or (t<0) or (st<0) or (sv<0) or (sz<0) or (sz>1) or \
 *        ((fabs(x)-(t-st/2.))<0) or (z+sz/2.>1) or (z-sz/2.<0) or (t-st/2.<0):
 *         return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":110
 * 
 *     # transform x,v,z if x is upper bound response
 *     if x > 0:             # <<<<<<<<<<<<<<
 *         v = -v
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":111
 *     # transform x,v,z if x is upper bound response
 *     if x > 0:
 *         v = -v             # <<<<<<<<<<<<<<
 *         z = 1.-z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":112
 *     if x > 0:
 *         v = -v
 *         z = 1.-z             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":114
 *         z = 1.-z
 * 
 *     x = fabs(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":116
 *     x = fabs(x)
 * 
 *     if st<1e-3:             # <<<<<<<<<<<<<<
 *         st = 0
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":117
 * 
 *     if st<1e-3:
 *         st = 0             # <<<<<<<<<<<<<<
 *     if sz <1e-3:
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":118
 *     if st<1e-3:
 *         st = 0
 *     if sz <1e-3:             # <<<<<<<<<<<<<<
 *         sz = 0
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":119
 *         st = 0
 *     if sz <1e-3:
 *         sz = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/pdf.pxi":121
 *         sz = 0
 * 
 *     if (sz==0):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":122
 * 
 *     if (sz==0):
 *         if (st==0): #sv=0,sz=0,st=0             # <<<<<<<<<<<<<<
 *             return pdf_sv(x - t, v, sv, a, z, err)
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":123
 *     if (sz==0):
 *         if (st==0): #sv=0,sz=0,st=0
 *             return pdf_sv(x - t, v, sv, a, z, err)             # <<<<<<<<<<<<<<
 *         else:      #sv=0,sz=0,st=$
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":125
 *             return pdf_sv(x - t, v, sv, a, z, err)
 *         else:      #sv=0,sz=0,st=$
 *             if use_adaptive>0:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":126
 *         else:      #sv=0,sz=0,st=$
 *             if use_adaptive>0:
 *                 return adaptiveSimpsons_1D(x,  v, sv, a, z, t, err, z, z, t-st/2., t+st/2., simps_err, n_st)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":128
 *                 return adaptiveSimpsons_1D(x,  v, sv, a, z, t, err, z, z, t-st/2., t+st/2., simps_err, n_st)
 *             else:
 *                 return simpson_1D(x, v, sv, a, z, t, err, z, z, 0, t-st/2., t+st/2., n_st)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/pdf.pxi":131
 * 
 *     else: #sz=$
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":132
 *     else: #sz=$
 *         if (st==0): #sv=0,sz=$,st=0
 *             if use_adaptive:             # <<<<<<<<<<<<<<
 *                 return adaptiveSimpsons_1D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., t, t, simps_err, n_sz)
 ...
 */
      if (__pyx_v_use_adaptive) {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":133
 *         if (st==0): #sv=0,sz=$,st=0
 *             if use_adaptive:
 *                 return adaptiveSimpsons_1D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., t, t, simps_err, n_sz)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":135
 *                 return adaptiveSimpsons_1D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., t, t, simps_err, n_sz)
 *             else:
 *                 return simpson_1D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., n_sz, t, t , 0)             # <<<<<<<<<<<<<<
 *         else:      #sv=0,sz=$,st=$
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/isofer/python/hddm/src/pdf.pxi":137
 *                 return simpson_1D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., n_sz, t, t , 0)
 *         else:      #sv=0,sz=$,st=$
 *             if use_adaptive:             # <<<<<<<<<<<<<<
 ...
 */
      if (__pyx_v_use_adaptive) {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":138
 *         else:      #sv=0,sz=$,st=$
 *             if use_adaptive:
 *                 return adaptiveSimpsons_2D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., t-st/2., t+st/2., simps_err, n_sz, n_st)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/home/isofer/python/hddm/src/pdf.pxi":140
 *                 return adaptiveSimpsons_2D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., t-st/2., t+st/2., simps_err, n_sz, n_st)
 *             else:
 *                 return simpson_2D(x, v, sv, a, z, t, err, z-sz/2., z+sz/2., n_sz, t-st/2., t+st/2., n_st)             # <<<<<<<<<<<<<<
 */
...
/* "/home/isofer/python/hddm/src/integrate.pxi":10
 * include 'pdf.pxi'
 * 
...
static double __pyx_f_4wfpt_simpson_1D(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_err, double __pyx_v_lb_z, double __pyx_v_ub_z, int __pyx_v_n_sz, double __pyx_v_lb_t, double __pyx_v_ub_t, int __pyx_v_n_st) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":16
 * 
 *     cdef double ht, hz
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":17
 *     cdef double ht, hz
 *     cdef int n = max(n_st, n_sz)
 *     if n_st==0: #integration over z             # <<<<<<<<<<<<<<
 *         hz = (ub_z-lb_z)/n
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":18
 *     cdef int n = max(n_st, n_sz)
 *     if n_st==0: #integration over z
 *         hz = (ub_z-lb_z)/n             # <<<<<<<<<<<<<<
 *         ht = 0
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":19
 *     if n_st==0: #integration over z
 *         hz = (ub_z-lb_z)/n
 *         ht = 0             # <<<<<<<<<<<<<<
 *         lb_t = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":20
 *         hz = (ub_z-lb_z)/n
 *         ht = 0
 *         lb_t = t             # <<<<<<<<<<<<<<
 *         ub_t = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":21
 *         ht = 0
 *         lb_t = t
 *         ub_t = t             # <<<<<<<<<<<<<<
 *     else: #integration over t
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":23
 *         ub_t = t
 *     else: #integration over t
 *         hz = 0             # <<<<<<<<<<<<<<
 *         ht = (ub_t-lb_t)/n
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":24
 *     else: #integration over t
 *         hz = 0
 *         ht = (ub_t-lb_t)/n             # <<<<<<<<<<<<<<
 *         lb_z = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":25
 *         hz = 0
 *         ht = (ub_t-lb_t)/n
 *         lb_z = z             # <<<<<<<<<<<<<<
 *         ub_z = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":26
 *         ht = (ub_t-lb_t)/n
 *         lb_z = z
 *         ub_z = z             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":28
 *         ub_z = z
 * 
 *     cdef double S = pdf_sv(x - lb_t, v, sv, a, lb_z, err)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":32
 *     cdef int i
 * 
 *     for i from 1 <= i <= n:             # <<<<<<<<<<<<<<
 *         z_tag = lb_z + hz * i
 ...
 */
  ...
  for (__pyx_v_i = 1; __pyx_v_i <= __pyx_t_3; __pyx_v_i++) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":33
 * 
 *     for i from 1 <= i <= n:
 *         z_tag = lb_z + hz * i             # <<<<<<<<<<<<<<
 *         t_tag = lb_t + ht * i
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":34
 *     for i from 1 <= i <= n:
 *         z_tag = lb_z + hz * i
 *         t_tag = lb_t + ht * i             # <<<<<<<<<<<<<<
 *         y = pdf_sv(x - t_tag, v, sv, a, z_tag, err)
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":35
 *         z_tag = lb_z + hz * i
 *         t_tag = lb_t + ht * i
 *         y = pdf_sv(x - t_tag, v, sv, a, z_tag, err)             # <<<<<<<<<<<<<<
 *         if i&1: #check if i is odd
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":36
 *         t_tag = lb_t + ht * i
 *         y = pdf_sv(x - t_tag, v, sv, a, z_tag, err)
 *         if i&1: #check if i is odd             # <<<<<<<<<<<<<<
 *             S += (4 * y)
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "/home/isofer/python/hddm/src/integrate.pxi":37
 *         y = pdf_sv(x - t_tag, v, sv, a, z_tag, err)
 *         if i&1: #check if i is odd
 *             S += (4 * y)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/isofer/python/hddm/src/integrate.pxi":39
 *             S += (4 * y)
 *         else:
 *             S += (2 * y)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":40
 *         else:
 *             S += (2 * y)
 *     S = S - y #the last term should be f(b) and not 2*f(b) so we subtract y             # <<<<<<<<<<<<<<
 *     S = S / ((ub_t-lb_t)+(ub_z-lb_z)) #the right function if pdf_sv()/sz or pdf_sv()/st
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":41
 *             S += (2 * y)
 *     S = S - y #the last term should be f(b) and not 2*f(b) so we subtract y
 *     S = S / ((ub_t-lb_t)+(ub_z-lb_z)) #the right function if pdf_sv()/sz or pdf_sv()/st             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":43
 *     S = S / ((ub_t-lb_t)+(ub_z-lb_z)) #the right function if pdf_sv()/sz or pdf_sv()/st
 * 
 *     return ((ht+hz) * S / 3)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/isofer/python/hddm/src/integrate.pxi":45
 *     return ((ht+hz) * S / 3)
 * 
 * cdef double simpson_2D(double x, double v, double sv, double a, double z, double t, double err, double lb_z, double ub_z, int n_sz, double lb_t, double ub_t, int n_st) nogil:             # <<<<<<<<<<<<<<
 *     #assert ((n_sz&1)==0 and (n_st&1)==0), "n_st and n_sz have to be even"
...
static double __pyx_f_4wfpt_simpson_2D(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_err, double __pyx_v_lb_z, double __pyx_v_ub_z, int __pyx_v_n_sz, double __pyx_v_lb_t, double __pyx_v_ub_t, int __pyx_v_n_st) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":54
 *     cdef int i_t
 * 
 *     ht = (ub_t-lb_t)/n_st             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":56
 *     ht = (ub_t-lb_t)/n_st
 * 
 *     S = simpson_1D(x, v, sv, a, z, lb_t, err, lb_z, ub_z, n_sz, 0, 0, 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":58
 *     S = simpson_1D(x, v, sv, a, z, lb_t, err, lb_z, ub_z, n_sz, 0, 0, 0)
 * 
 *     for i_t  from 1 <= i_t <= n_st:             # <<<<<<<<<<<<<<
 *         t_tag = lb_t + ht * i_t
 ...
 */
  ...
  for (__pyx_v_i_t = 1; __pyx_v_i_t <= __pyx_t_1; __pyx_v_i_t++) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":59
 * 
 *     for i_t  from 1 <= i_t <= n_st:
 *         t_tag = lb_t + ht * i_t             # <<<<<<<<<<<<<<
 *         y = simpson_1D(x, v, sv, a, z, t_tag, err, lb_z, ub_z, n_sz, 0, 0, 0)
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":60
 *     for i_t  from 1 <= i_t <= n_st:
 *         t_tag = lb_t + ht * i_t
 *         y = simpson_1D(x, v, sv, a, z, t_tag, err, lb_z, ub_z, n_sz, 0, 0, 0)             # <<<<<<<<<<<<<<
 *         if i_t&1: #check if i is odd
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":61
 *         t_tag = lb_t + ht * i_t
 *         y = simpson_1D(x, v, sv, a, z, t_tag, err, lb_z, ub_z, n_sz, 0, 0, 0)
 *         if i_t&1: #check if i is odd             # <<<<<<<<<<<<<<
 *             S += (4 * y)
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/home/isofer/python/hddm/src/integrate.pxi":62
 *         y = simpson_1D(x, v, sv, a, z, t_tag, err, lb_z, ub_z, n_sz, 0, 0, 0)
 *         if i_t&1: #check if i is odd
 *             S += (4 * y)             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/isofer/python/hddm/src/integrate.pxi":64
 *             S += (4 * y)
 *         else:
 *             S += (2 * y)             # <<<<<<<<<<<<<<
 *     S = S - y #the last term should be f(b) and not 2*f(b) so we subtract y
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":65
 *         else:
 *             S += (2 * y)
 *     S = S - y #the last term should be f(b) and not 2*f(b) so we subtract y             # <<<<<<<<<<<<<<
 *     S = S/ (ub_t-lb_t)
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":66
 *             S += (2 * y)
 *     S = S - y #the last term should be f(b) and not 2*f(b) so we subtract y
 *     S = S/ (ub_t-lb_t)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":68
 *     S = S/ (ub_t-lb_t)
 * 
 *     return (ht * S / 3)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/isofer/python/hddm/src/integrate.pxi":70
 *     return (ht * S / 3)
 * 
 * cdef double adaptiveSimpsonsAux(double x, double v, double sv, double a, double z, double t, double pdf_err,             # <<<<<<<<<<<<<<
...
static double __pyx_f_4wfpt_adaptiveSimpsonsAux(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_pdf_err, double __pyx_v_lb_z, double __pyx_v_ub_z, double __pyx_v_lb_t, double __pyx_v_ub_t, double __pyx_v_ZT, double __pyx_v_simps_err, double __pyx_v_S, double __pyx_v_f_beg, double __pyx_v_f_end, double __pyx_v_f_mid, int __pyx_v_bottom) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":79
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":80
 * 
 *     if (ub_t-lb_t) == 0: #integration over sz
 *         h = ub_z - lb_z             # <<<<<<<<<<<<<<
 *         z_c = (ub_z + lb_z)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":81
 *     if (ub_t-lb_t) == 0: #integration over sz
 *         h = ub_z - lb_z
 *         z_c = (ub_z + lb_z)/2.             # <<<<<<<<<<<<<<
 *         z_d = (lb_z + z_c)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":82
 *         h = ub_z - lb_z
 *         z_c = (ub_z + lb_z)/2.
 *         z_d = (lb_z + z_c)/2.             # <<<<<<<<<<<<<<
 *         z_e = (z_c  + ub_z)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":83
 *         z_c = (ub_z + lb_z)/2.
 *         z_d = (lb_z + z_c)/2.
 *         z_e = (z_c  + ub_z)/2.             # <<<<<<<<<<<<<<
 *         t_c = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":84
 *         z_d = (lb_z + z_c)/2.
 *         z_e = (z_c  + ub_z)/2.
 *         t_c = t             # <<<<<<<<<<<<<<
 *         t_d = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":85
 *         z_e = (z_c  + ub_z)/2.
 *         t_c = t
 *         t_d = t             # <<<<<<<<<<<<<<
 *         t_e = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":86
 *         t_c = t
 *         t_d = t
 *         t_e = t             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":89
 * 
 *     else: #integration over t
 *         h = ub_t - lb_t             # <<<<<<<<<<<<<<
 *         t_c = (ub_t + lb_t)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":90
 *     else: #integration over t
 *         h = ub_t - lb_t
 *         t_c = (ub_t + lb_t)/2.             # <<<<<<<<<<<<<<
 *         t_d = (lb_t + t_c)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":91
 *         h = ub_t - lb_t
 *         t_c = (ub_t + lb_t)/2.
 *         t_d = (lb_t + t_c)/2.             # <<<<<<<<<<<<<<
 *         t_e = (t_c  + ub_t)/2.
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":92
 *         t_c = (ub_t + lb_t)/2.
 *         t_d = (lb_t + t_c)/2.
 *         t_e = (t_c  + ub_t)/2.             # <<<<<<<<<<<<<<
 *         z_c = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":93
 *         t_d = (lb_t + t_c)/2.
 *         t_e = (t_c  + ub_t)/2.
 *         z_c = z             # <<<<<<<<<<<<<<
 *         z_d = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":94
 *         t_e = (t_c  + ub_t)/2.
 *         z_c = z
 *         z_d = z             # <<<<<<<<<<<<<<
 *         z_e = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":95
 *         z_c = z
 *         z_d = z
 *         z_e = z             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":97
 *         z_e = z
 * 
 *     fd = pdf_sv(x - t_d, v, sv, a, z_d, pdf_err)/ZT             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":98
 * 
 *     fd = pdf_sv(x - t_d, v, sv, a, z_d, pdf_err)/ZT
 *     fe = pdf_sv(x - t_e, v, sv, a, z_e, pdf_err)/ZT             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":100
 *     fe = pdf_sv(x - t_e, v, sv, a, z_e, pdf_err)/ZT
 * 
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":101
 * 
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)             # <<<<<<<<<<<<<<
 *     S2 = Sleft + Sright
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":102
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)
 *     S2 = Sleft + Sright             # <<<<<<<<<<<<<<
 *     if (bottom <= 0 or fabs(S2 - S) <= 15*simps_err):
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":103
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)
 *     S2 = Sleft + Sright
 *     if (bottom <= 0 or fabs(S2 - S) <= 15*simps_err):             # <<<<<<<<<<<<<<
 *         return S2 + (S2 - S)/15
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":104
 *     S2 = Sleft + Sright
 *     if (bottom <= 0 or fabs(S2 - S) <= 15*simps_err):
 *         return S2 + (S2 - S)/15             # <<<<<<<<<<<<<<
 *     return adaptiveSimpsonsAux(x, v, sv, a, z, t, pdf_err,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":110
...
/* "/home/isofer/python/hddm/src/integrate.pxi":112
 *                                  Sright, f_mid, f_end, fe, bottom-1)
 * 
 * cdef double adaptiveSimpsons_1D(double x, double v, double sv, double a, double z, double t,             # <<<<<<<<<<<<<<
...
static double __pyx_f_4wfpt_adaptiveSimpsons_1D(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_pdf_err, double __pyx_v_lb_z, double __pyx_v_ub_z, double __pyx_v_lb_t, double __pyx_v_ub_t, double __pyx_v_simps_err, int __pyx_v_maxRecursionDepth) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":118
 *     cdef double h
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":119
 * 
 *     if (ub_t - lb_t) == 0: #integration over z
 *         lb_t = t             # <<<<<<<<<<<<<<
 *         ub_t = t
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":120
 *     if (ub_t - lb_t) == 0: #integration over z
 *         lb_t = t
 *         ub_t = t             # <<<<<<<<<<<<<<
 *         h = ub_z - lb_z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":121
 *         lb_t = t
 *         ub_t = t
 *         h = ub_z - lb_z             # <<<<<<<<<<<<<<
 *     else: #integration over t
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":123
 *         h = ub_z - lb_z
 *     else: #integration over t
 *         h = (ub_t-lb_t)             # <<<<<<<<<<<<<<
 *         lb_z = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":124
 *     else: #integration over t
 *         h = (ub_t-lb_t)
 *         lb_z = z             # <<<<<<<<<<<<<<
 *         ub_z = z
 ...
 */
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":125
 *         h = (ub_t-lb_t)
 *         lb_z = z
 *         ub_z = z             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":127
 *         ub_z = z
 * 
 *     cdef double ZT = h             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":128
 * 
 *     cdef double ZT = h
 *     cdef double c_t = (lb_t + ub_t)/2.             # <<<<<<<<<<<<<<
 *     cdef double c_z = (lb_z + ub_z)/2.
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":129
 *     cdef double ZT = h
 *     cdef double c_t = (lb_t + ub_t)/2.
 *     cdef double c_z = (lb_z + ub_z)/2.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":132
 * 
 *     cdef double f_beg, f_end, f_mid, S
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":133
 *     cdef double f_beg, f_end, f_mid, S
 *     f_beg = pdf_sv(x - lb_t, v, sv, a, lb_z, pdf_err)/ZT
 *     f_end = pdf_sv(x - ub_t, v, sv, a, ub_z, pdf_err)/ZT             # <<<<<<<<<<<<<<
 *     f_mid = pdf_sv(x - c_t, v, sv, a, c_z, pdf_err)/ZT
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":134
 *     f_beg = pdf_sv(x - lb_t, v, sv, a, lb_z, pdf_err)/ZT
 *     f_end = pdf_sv(x - ub_t, v, sv, a, ub_z, pdf_err)/ZT
 *     f_mid = pdf_sv(x - c_t, v, sv, a, c_z, pdf_err)/ZT             # <<<<<<<<<<<<<<
 *     S = (h/6)*(f_beg + 4*f_mid + f_end)
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":135
 *     f_end = pdf_sv(x - ub_t, v, sv, a, ub_z, pdf_err)/ZT
 *     f_mid = pdf_sv(x - c_t, v, sv, a, c_z, pdf_err)/ZT
 *     S = (h/6)*(f_beg + 4*f_mid + f_end)             # <<<<<<<<<<<<<<
 *     cdef double res =  adaptiveSimpsonsAux(x, v, sv, a, z, t, pdf_err,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":138
 *     cdef double res =  adaptiveSimpsonsAux(x, v, sv, a, z, t, pdf_err,
 *                                  lb_z, ub_z, lb_t, ub_t, ZT, simps_err,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":139
 *                                  lb_z, ub_z, lb_t, ub_t, ZT, simps_err,
 *                                  S, f_beg, f_end, f_mid, maxRecursionDepth)
 *     return res             # <<<<<<<<<<<<<<
 * 
...
/* "/home/isofer/python/hddm/src/integrate.pxi":141
 *     return res
 * 
 * cdef double adaptiveSimpsonsAux_2D(double x, double v, double sv,             # <<<<<<<<<<<<<<
...
static double __pyx_f_4wfpt_adaptiveSimpsonsAux_2D(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_pdf_err, double __pyx_v_err_1d, double __pyx_v_lb_z, double __pyx_v_ub_z, double __pyx_v_lb_t, double __pyx_v_ub_t, double __pyx_v_st, double __pyx_v_err_2d, double __pyx_v_S, double __pyx_v_f_beg, double __pyx_v_f_end, double __pyx_v_f_mid, int __pyx_v_maxRecursionDepth_sz, int __pyx_v_bottom) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":154
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":155
 * 
 *     cdef double t_c = (ub_t + lb_t)/2.
 *     cdef double t_d = (lb_t + t_c)/2.             # <<<<<<<<<<<<<<
 *     cdef double t_e = (t_c  + ub_t)/2.
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":156
 *     cdef double t_c = (ub_t + lb_t)/2.
 *     cdef double t_d = (lb_t + t_c)/2.
 *     cdef double t_e = (t_c  + ub_t)/2.             # <<<<<<<<<<<<<<
 *     cdef double h = ub_t - lb_t
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":157
 *     cdef double t_d = (lb_t + t_c)/2.
 *     cdef double t_e = (t_c  + ub_t)/2.
 *     cdef double h = ub_t - lb_t             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":160
 * 
 *     fd = adaptiveSimpsons_1D(x, v, sv, a, z, t_d, pdf_err, lb_z, ub_z,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":162
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st
 *     fe = adaptiveSimpsons_1D(x, v, sv, a, z, t_e, pdf_err, lb_z, ub_z,
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":164
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st
 * 
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)             # <<<<<<<<<<<<<<
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":165
 * 
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)             # <<<<<<<<<<<<<<
 *     S2 = Sleft + Sright
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":166
 *     Sleft = (h/12)*(f_beg + 4*fd + f_mid)
 *     Sright = (h/12)*(f_mid + 4*fe + f_end)
 *     S2 = Sleft + Sright             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":168
 *     S2 = Sleft + Sright
 * 
 *     if (bottom <= 0 or fabs(S2 - S) <= 15*err_2d):             # <<<<<<<<<<<<<<
 *         return S2 + (S2 - S)/15;
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/home/isofer/python/hddm/src/integrate.pxi":169
 * 
 *     if (bottom <= 0 or fabs(S2 - S) <= 15*err_2d):
 *         return S2 + (S2 - S)/15;             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":176
...
/* "/home/isofer/python/hddm/src/integrate.pxi":179
 * 
 * 
...
static double __pyx_f_4wfpt_adaptiveSimpsons_2D(double __pyx_v_x, double __pyx_v_v, double __pyx_v_sv, double __pyx_v_a, double __pyx_v_z, double __pyx_v_t, double __pyx_v_pdf_err, double __pyx_v_lb_z, double __pyx_v_ub_z, double __pyx_v_lb_t, double __pyx_v_ub_t, double __pyx_v_simps_err, int __pyx_v_maxRecursionDepth_sz, int __pyx_v_maxRecursionDepth_st) {
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":183
 *                                  double simps_err, int maxRecursionDepth_sz, int maxRecursionDepth_st) nogil:
 * 
 *     cdef double h = (ub_t-lb_t)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":185
 *     cdef double h = (ub_t-lb_t)
 * 
 *     cdef double st = (ub_t - lb_t)             # <<<<<<<<<<<<<<
 *     cdef double c_t = (lb_t + ub_t)/2.
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":186
 * 
 *     cdef double st = (ub_t - lb_t)
 *     cdef double c_t = (lb_t + ub_t)/2.             # <<<<<<<<<<<<<<
 *     cdef double c_z = (lb_z + ub_z)/2.
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":187
 *     cdef double st = (ub_t - lb_t)
 *     cdef double c_t = (lb_t + ub_t)/2.
 *     cdef double c_z = (lb_z + ub_z)/2.             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":190
 * 
 *     cdef double f_beg, f_end, f_mid, S
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":191
 *     cdef double f_beg, f_end, f_mid, S
 *     cdef double err_1d = simps_err
 *     cdef double err_2d = simps_err             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":194
 * 
 *     f_beg = adaptiveSimpsons_1D(x, v, sv, a, z, lb_t, pdf_err, lb_z, ub_z,
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":197
 * 
 *     f_end = adaptiveSimpsons_1D(x, v, sv, a, z, ub_t, pdf_err, lb_z, ub_z,
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":199
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st
 *     f_mid = adaptiveSimpsons_1D(x, v, sv, a, z, (lb_t+ub_t)/2, pdf_err, lb_z, ub_z,
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st             # <<<<<<<<<<<<<<
 *     S = (h/6)*(f_beg + 4*f_mid + f_end)
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":200
 *     f_mid = adaptiveSimpsons_1D(x, v, sv, a, z, (lb_t+ub_t)/2, pdf_err, lb_z, ub_z,
 *                               0, 0, err_1d, maxRecursionDepth_sz)/st
 *     S = (h/6)*(f_beg + 4*f_mid + f_end)             # <<<<<<<<<<<<<<
 *     cdef double res =  adaptiveSimpsonsAux_2D(x, v, sv, a, z, t, pdf_err, err_1d,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":203
 *     cdef double res =  adaptiveSimpsonsAux_2D(x, v, sv, a, z, t, pdf_err, err_1d,
 *                                  lb_z, ub_z, lb_t, ub_t, st, err_2d,
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":204
 *                                  lb_z, ub_z, lb_t, ub_t, st, err_2d,
 *                                  S, f_beg, f_end, f_mid, maxRecursionDepth_sz, maxRecursionDepth_st)
 *     return res             # <<<<<<<<<<<<<<
 */
...
static char __pyx_doc_4wfpt_1pdf_array[] = "pdf_array(ndarray x, double v, double sv, double a, double z, double sz, double t, double st, double err=0.0001, int logp=0, int n_st=2, int n_sz=2, int use_adaptive=1, double simps_err=0.001, double p_outlier=0, double w_outlier=0)";
 ...
 */
  ...
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_3), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    __pyx_t_14 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_y, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
...
static char __pyx_doc_4wfpt_2wiener_like[] = "wiener_like(ndarray x, double v, double sv, double a, double z, double sz, double t, double st, double err, int n_st=10, int n_sz=10, int use_adaptive=1, double simps_err=1e-08, double p_outlier=0, double w_outlier=0)";
...
static PyObject *__pyx_pf_4wfpt_2wiener_like(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "wiener_like") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case 15: values[14] = PyTuple_GET_ITEM(__pyx_args, 14);
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x = __pyx_bstruct_x.strides[0];
  __pyx_bshape_0_x = __pyx_bstruct_x.shape[0];
 ...
 */
                            ...
                            __pyx_t_8 = __pyx_f_4wfpt_full_pdf((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_x.buf, __pyx_t_7, __pyx_bstride_0_x)), __pyx_v_v, __pyx_v_sv, __pyx_v_a, __pyx_v_z, __pyx_v_sz, __pyx_v_t, __pyx_v_st, __pyx_v_err, 0, &__pyx_t_9); 
                            __pyx_v_p = __pyx_t_8;
 ...
 */
                                    __Pyx_XDECREF(__pyx_r);
                                    __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                    __Pyx_GOTREF(__pyx_t_2);
                                    __pyx_t_3 = PyObject_GetAttr(__pyx_t_2, __pyx_n_s__inf); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                    __Pyx_GOTREF(__pyx_t_3);
                                    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
                                    __pyx_t_2 = PyNumber_Negative(__pyx_t_3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 67; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                    __Pyx_GOTREF(__pyx_t_2);
                                    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
                                    #ifdef _OPENMP
...
static char __pyx_doc_4wfpt_3wiener_like_multi[] = "wiener_like_multi(ndarray x, v, sv, a, z, sz, t, st, double err, multi=None, int n_st=10, int n_sz=10, int use_adaptive=1, double simps_err=0.001, double p_outlier=0, double w_outlier=0)";
...
static PyObject *__pyx_pf_4wfpt_3wiener_like_multi(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "wiener_like_multi") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case 16: values[15] = PyTuple_GET_ITEM(__pyx_args, 15);
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x = __pyx_bstruct_x.strides[0];
  __pyx_bshape_0_x = __pyx_bstruct_x.shape[0];
 ...
 */
      ...
      __pyx_t_2 = __pyx_f_4wfpt_full_pdf((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_x.buf, __pyx_t_14, __pyx_bstride_0_x)), __pyx_t_9, __pyx_t_8, __pyx_t_7, __pyx_t_6, __pyx_t_5, __pyx_t_4, __pyx_t_3, __pyx_v_err, 0, &__pyx_t_16); 
      __pyx_v_p = __pyx_t_2;
...
static char __pyx_doc_4wfpt_4gen_rts_from_cdf[] = "gen_rts_from_cdf(double v, double sv, double a, double z, double sz, double t, double st, int samples=1000, double cdf_lb=-6, double cdf_ub=6, double dt=0.01)";
...
static PyObject *__pyx_pf_4wfpt_4gen_rts_from_cdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "gen_rts_from_cdf") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case 11: values[10] = PyTuple_GET_ITEM(__pyx_args, 10);
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyEval_CallObjectWithKeywords(__pyx_t_5, ((PyObject *)__pyx_t_2), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_l_cdf.buf, __pyx_t_13, __pyx_bstride_0_l_cdf))); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_2), ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
 ...
 */
    ...
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_2 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_f.buf, __pyx_t_9, __pyx_bstride_0_f))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
      ...
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;
      if (unlikely(!__pyx_v_delay)) { __Pyx_RaiseUnboundLocalError("delay"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }__pyx_t_24 = __pyx_v_i;
      __pyx_t_4 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_delay.buf, __pyx_t_24, __pyx_bstride_0_delay))); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
...
static char __pyx_doc_4wfpt_5wiener_like_contaminant[] = "wiener_like_contaminant(ndarray x, ndarray cont_x, double v, double sv, double a, double z, double sz, double t, double st, double t_min, double t_max, double err, int n_st=10, int n_sz=10, int use_adaptive=1, double simps_err=1e-08)\nWiener likelihood function where RTs could come from a\n    separate, uniform contaminant distribution.\n\n    Reference: Lee, Vandekerckhove, Navarro, & Tuernlinckx (2007)\n    ";
...
static PyObject *__pyx_pf_4wfpt_5wiener_like_contaminant(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "wiener_like_contaminant") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case 16: values[15] = PyTuple_GET_ITEM(__pyx_args, 15);
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x = __pyx_bstruct_x.strides[0];
  __pyx_bshape_0_x = __pyx_bstruct_x.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_cont_x, (PyObject*)__pyx_v_cont_x, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            if (__pyx_t_7 > 0)
            {
                __pyx_v_i = 0;
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_sum_logp) private(__pyx_t_12, __pyx_t_11, __pyx_t_9, __pyx_t_10, __pyx_t_8) firstprivate(__pyx_t_3, __pyx_t_1) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef WITH_THREAD
                    PyGILState_STATE __pyx_gilstate_save = PyGILState_Ensure();
 ...
 */
                                      __Pyx_XDECREF(__pyx_r);
                                      __pyx_t_3 = __Pyx_GetName(__pyx_m, __pyx_n_s__np); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                      __Pyx_GOTREF(__pyx_t_3);
                                      __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__inf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                      __Pyx_GOTREF(__pyx_t_1);
                                      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
                                      __pyx_t_3 = PyNumber_Negative(__pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 155; __pyx_clineno = __LINE__; goto __pyx_L18;}
                                      __Pyx_GOTREF(__pyx_t_3);
                                      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
                                      #ifdef _OPENMP
                                      #pragma omp critical(__pyx_returning)
...
static PyObject *__pyx_pf_4wfpt_6gen_cdf_using_pdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4wfpt_6gen_cdf_using_pdf[] = "gen_cdf_using_pdf(double v, double sv, double a, double z, double sz, double t, double st, double err, int N=500, double time=5.0, int n_st=2, int n_sz=2, int use_adaptive=1, double simps_err=0.001, double p_outlier=0, double w_outlier=0)\n\n    generate cdf vector using the pdf\n    ";
static PyMethodDef __pyx_mdef_4wfpt_6gen_cdf_using_pdf = {__Pyx_NAMESTR("gen_cdf_using_pdf"), (PyCFunction)__pyx_pf_4wfpt_6gen_cdf_using_pdf, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4wfpt_6gen_cdf_using_pdf)};
static PyObject *__pyx_pf_4wfpt_6gen_cdf_using_pdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  double __pyx_v_v;
  double __pyx_v_sv;
  double __pyx_v_a;
  double __pyx_v_z;
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "gen_cdf_using_pdf") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case 16: values[15] = PyTuple_GET_ITEM(__pyx_args, 15);
 ...
 */
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_t_19, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_x = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_x.buf = NULL;
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
  __pyx_t_14 = PyEval_CallObjectWithKeywords(__pyx_t_18, ((PyObject *)__pyx_t_15), ((PyObject *)__pyx_t_17)); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_14);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_cdf_array, (PyObject*)__pyx_t_20, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_cdf_array = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_bstruct_cdf_array.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 176; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_bstride_0_cdf_array = __pyx_bstruct_cdf_array.strides[0];
 ...
 */
  ...
  __pyx_t_20 = ((PyArrayObject *)__pyx_t_30);
  {
    ...
    __pyx_t_32 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_cdf_array, (PyObject*)__pyx_t_20, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
 ...
 */
  ...
  if (unlikely(!__pyx_v_cdf_array)) { __Pyx_RaiseUnboundLocalError("cdf_array"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }if (__Pyx_PySequence_SetSlice(((PyObject *)__pyx_v_cdf_array), 1, PY_SSIZE_T_MAX, __pyx_t_14) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
 ...
 */
  ...
  __pyx_t_14 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_cdf_array.buf, __pyx_t_36, __pyx_bstride_0_cdf_array))); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_14);
...
static PyObject *__pyx_pf_4wfpt_7split_cdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4wfpt_7split_cdf[] = "split_cdf(ndarray x, ndarray data)";
static PyMethodDef __pyx_mdef_4wfpt_7split_cdf = {__Pyx_NAMESTR("split_cdf"), (PyCFunction)__pyx_pf_4wfpt_7split_cdf, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4wfpt_7split_cdf)};
static PyObject *__pyx_pf_4wfpt_7split_cdf(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_x = 0;
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "split_cdf") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_x = __pyx_bstruct_x.strides[0];
  __pyx_bshape_0_x = __pyx_bstruct_x.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_16 = 0;
  __pyx_t_9 = PyFloat_FromDouble((*__Pyx_BufPtrStrided1d(double *, __pyx_bstruct_ub.buf, __pyx_t_16, __pyx_bstride_0_ub))); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 204; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__copy); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "/home/isofer/python/hddm/src/integrate.pxi":4
 ...
 *               double simps_err=1e-3, double p_outlier=0, double w_outlier=0):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_1pdf_array, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                 double p_outlier=0, double w_outlier=0):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_2wiener_like, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                       double p_outlier=0, double w_outlier=0):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_3wiener_like_multi, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_4gen_rts_from_cdf, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *                                  double t_max, double err, int n_st= 10, int n_sz=10, bint use_adaptive=1, \
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_5wiener_like_contaminant, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_19, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *             double p_outlier=0, double w_outlier=0):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_6gen_cdf_using_pdf, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     #get length of data
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfpt_7split_cdf, NULL, __pyx_n_s__wfpt); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
