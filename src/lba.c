/* Generated by Cython 0.19.1 on Mon Oct  7 18:07:45 2013 */
...
static CYTHON_INLINE int __pyx_f_3lba_p_outlier_in_range(double); /*proto*/
...
static PyObject *__pyx_pf_3lba_lba_like(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_value, double __pyx_v_z, double __pyx_v_a, double __pyx_v_ter, double __pyx_v_sv, double __pyx_v_v0, double __pyx_v_v1, int __pyx_v_normalize_v, double __pyx_v_p_outlier, double __pyx_v_w_outlier); /* proto */
...
static CYTHON_INLINE int __pyx_f_3lba_p_outlier_in_range(double __pyx_v_p_outlier) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
static PyObject *__pyx_pw_3lba_1lba_like(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__value,&__pyx_n_s__z,&__pyx_n_s__a,&__pyx_n_s__ter,&__pyx_n_s__sv,&__pyx_n_s__v0,&__pyx_n_s__v1,&__pyx_n_s__normalize_v,&__pyx_n_s__p_outlier,&__pyx_n_s__w_outlier,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__z)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__ter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__sv)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__v0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__v1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "lba_like") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_z = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_z == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ter = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_ter == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_sv = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_sv == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_v0 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_v0 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_v1 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_v1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[7]) {
      __pyx_v_normalize_v = __Pyx_PyObject_IsTrue(values[7]); if (unlikely((__pyx_v_normalize_v == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
 ...
 */
    ...
    if (values[8]) {
      __pyx_v_p_outlier = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_p_outlier == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_p_outlier = ((double)0.0);
    }
    if (values[9]) {
      __pyx_v_w_outlier = __pyx_PyFloat_AsDouble(values[9]); if (unlikely((__pyx_v_w_outlier == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("lba_like", 0, 7, 10, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("lba.lba_like", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_value), __pyx_ptype_5numpy_ndarray, 1, "value", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_3lba_lba_like(__pyx_self, __pyx_v_value, __pyx_v_z, __pyx_v_a, __pyx_v_ter, __pyx_v_sv, __pyx_v_v0, __pyx_v_v1, __pyx_v_normalize_v, __pyx_v_p_outlier, __pyx_v_w_outlier);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_3lba_lba_like(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_value, double __pyx_v_z, double __pyx_v_a, double __pyx_v_ter, double __pyx_v_sv, double __pyx_v_v0, double __pyx_v_v1, int __pyx_v_normalize_v, double __pyx_v_p_outlier, double __pyx_v_w_outlier) {
  CYTHON_UNUSED PyArrayObject *__pyx_v_rt = 0;
  ...
  __pyx_pybuffernd_value.rcbuffer = &__pyx_pybuffer_value;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_value.rcbuffer->pybuffer, (PyObject*)__pyx_v_value, &__Pyx_TypeInfo_nn___pyx_t_3lba_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s__abs); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_ter); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 * 
 */
  __pyx_t_5 = ((!(__pyx_f_3lba_p_outlier_in_range(__pyx_v_p_outlier) != 0)) != 0);
  if (__pyx_t_5) {
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__inf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Negative(__pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_5 = ((__pyx_v_normalize_v == 1) != 0);
  if (__pyx_t_5) {
 ...
 *         return -np.Inf
 */
  __pyx_t_5 = ((__pyx_v_a <= __pyx_v_z) != 0);
  if (__pyx_t_5) {
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__Inf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Negative(__pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_r = __pyx_t_2;
    __pyx_t_2 = 0;
 ...
 */
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_5 = (((*__Pyx_BufPtrStrided1d(__pyx_t_3lba_DTYPE_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_value.diminfo[0].strides)) > 0.0) != 0);
    if (__pyx_t_5) {
 ...
 */
      ...
      __pyx_v_p = ((1.0 - __pyx_f_3lba_fptcdf_single(fabs((*__Pyx_BufPtrStrided1d(__pyx_t_3lba_DTYPE_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_value.diminfo[0].strides))), __pyx_v_z, __pyx_v_a, __pyx_v_v1, __pyx_v_sv)) * __pyx_f_3lba_fptpdf_single(fabs((*__Pyx_BufPtrStrided1d(__pyx_t_3lba_DTYPE_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_value.diminfo[0].strides))), __pyx_v_z, __pyx_v_a, __pyx_v_v0, __pyx_v_sv));
      goto __pyx_L8;
    }
    /*else*/ {
 ...
 */
      ...
      __pyx_v_p = ((1.0 - __pyx_f_3lba_fptcdf_single(fabs((*__Pyx_BufPtrStrided1d(__pyx_t_3lba_DTYPE_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_value.diminfo[0].strides))), __pyx_v_z, __pyx_v_a, __pyx_v_v0, __pyx_v_sv)) * __pyx_f_3lba_fptpdf_single(fabs((*__Pyx_BufPtrStrided1d(__pyx_t_3lba_DTYPE_t *, __pyx_pybuffernd_value.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_value.diminfo[0].strides))), __pyx_v_z, __pyx_v_a, __pyx_v_v1, __pyx_v_sv));
    }
    __pyx_L8:;
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s__inf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_sum_logp); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 *     cdef Py_ssize_t size = value.shape[0]
 */
  __pyx_k_tuple_16 = PyTuple_Pack(16, ((PyObject *)__pyx_n_s__value), ((PyObject *)__pyx_n_s__z), ((PyObject *)__pyx_n_s__a), ((PyObject *)__pyx_n_s__ter), ((PyObject *)__pyx_n_s__sv), ((PyObject *)__pyx_n_s__v0), ((PyObject *)__pyx_n_s__v1), ((PyObject *)__pyx_n_s__normalize_v), ((PyObject *)__pyx_n_s__p_outlier), ((PyObject *)__pyx_n_s__w_outlier), ((PyObject *)__pyx_n_s__rt), ((PyObject *)__pyx_n_s__size), ((PyObject *)__pyx_n_s__i), ((PyObject *)__pyx_n_s__sum_logp), ((PyObject *)__pyx_n_s__p), ((PyObject *)__pyx_n_s__wp_outlier)); if (unlikely(!__pyx_k_tuple_16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_16);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_16));
  __pyx_k_codeobj_17 = (PyObject*)__Pyx_PyCode_New(10, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_18, __pyx_n_s__lba_like, 61, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *     cdef Py_ssize_t size = value.shape[0]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_3lba_1lba_like, NULL, __pyx_n_s__lba); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__lba_like, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
