...
setup(
    ...
    install_requires=['NumPy >=1.6.0', 'SciPy >= 0.6.0', 'kabuki >= 0.5.3', 'PyMC==2.3.3', 'pandas >= 0.12.0', 'patsy'],
    setup_requires=['NumPy >=1.6.0', 'SciPy >= 0.6.0', 'kabuki >= 0.5.3', 'PyMC==2.3.3', 'pandas >= 0.12.0', 'patsy'],
