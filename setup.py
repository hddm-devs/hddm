...
setup(
    ...
    packages=['hddm', 'hddm.tests', 'hddm.models', 'hddm.examples', 'hddm.keras_models', 'hddm.cnn', 'hddm.cnn_models', 'hddm.torch', 'hddm.torch_models', 'hddm.simulators'],
    package_data={'hddm':['examples/*.csv', 'examples/*.conf', 'keras_models/*.h5', 'cnn_models/*/*', 'torch_models/*' 'simulators/*']},
