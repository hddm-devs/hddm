...
setup(
    ...
    install_requires=['NumPy >=1.6.0', 'SciPy >= 0.6.0', 'kabuki >= 0.5.2.beta', 'PyMC == 2.2', 'pandas >= 0.10.0', 'patsy'],
    setup_requires=['NumPy >=1.6.0', 'SciPy >= 0.6.0', 'kabuki >= 0.5.2.beta', 'PyMC == 2.2', 'pandas >= 0.10.0', 'patsy'],
