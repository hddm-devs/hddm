        ...
        if self.nn:
            ...
            if model_config[self.model]["n_choices"] == 2:
                ...
                if (
                    ...
                    or self.model == "weibull_cdf_concave"
                ):
                    wfpt_parents["alpha"] = (
                        knodes["alpha_bottom"]
                        if "alpha" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("alpha")
                        ]
                    )
                    wfpt_parents["beta"] = (
                        knodes["beta_bottom"]
                        if "beta" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("beta")
                        ]
                    )
                ...
                if self.model == "ornstein":
                    wfpt_parents["g"] = (
                        knodes["g_bottom"]
                        if "g" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("g")
                        ]
                    )
                ...
                if self.model == "angle":
                    wfpt_parents["theta"] = (
                        knodes["theta_bottom"]
                        if "theta" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("theta")
                        ]
                    )
                ...
                if self.model == "full_ddm" or self.model == "full_ddm2":
                    wfpt_parents["sv"] = (
                        ...
                        if "sv" in self.include
                            ...
                            model_config[self.model]["params"].index("sv")
                        ]
                    )  # self.default_intervars['sv']
                    wfpt_parents["sz"] = (
                        knodes["sz_bottom"]
                        if "sz" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("sz")
                        ]
                    )  # self.default_intervars['sz']
                    wfpt_parents["st"] = (
                        knodes["st_bottom"]
                        if "st" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("st")
                        ]
                    )  # self.default_intervars['st']
            # ------------------------------------------------------------------------------------------------------------------
            ...
            # N CHOICE SSM -----------------------------------------------------------------------------------------------------
                ...
                if self.model == "ddm_par2":
                    wfpt_parents["v_h"] = (
                        knodes["v_h_bottom"]
                        if "v_h" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("v_h")
                        ]
                    )
                    wfpt_parents["v_l_1"] = (
                        knodes["v_l_1_bottom"]
                        if "v_l_1" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("v_l_1")
                        ]
                    )
                    wfpt_parents["v_l_2"] = (
                        knodes["v_l_2_bottom"]
                        if "v_l_2" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("v_l_2")
                        ]
                    )
                    wfpt_parents["a"] = (
                        knodes["a_bottom"]
                        if "a" in self.include
                            ...
                            model_config[self.model]["params"].index("a")
                        ]
                    )
                    wfpt_parents["z_h"] = (
                        knodes["z_h_bottom"]
                        if "z_h" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("z_h")
                        ]
                    )
                    wfpt_parents["z_l_1"] = (
                        knodes["z_l_1_bottom"]
                        if "z_l_1" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("z_l_1")
                        ]
                    )
                    wfpt_parents["z_l_2"] = (
                        knodes["z_l_2_bottom"]
                        if "z_l_2" in self.include
                        else model_config[self.model]["default_params"][
                            model_config[self.model]["params"].index("z_l_2")
                        ]
                    )
                    wfpt_parents["t"] = (
                        knodes["t_bottom"]
                        if "t" in self.include
                            ...
                            model_config[self.model]["params"].index("t")
                        ]
                    )
                ...
                if self.model == "ddm_mic2":
                    ...
                    wfpt_parents["d"] = (
                        ...
                        if "d" in self.include
                            ...
                            model_config[self.model]["params"].index("d")
                        ]
                    )
                    wfpt_parents["t"] = (
                        knodes["t_bottom"]
