...
class TestGenerate(unittest.TestCase):
    def test_compare_drift_simulated_data_to_analytic(self):
        raise SkipTest(
            "The function used KStest in the past, but since Wfpt is not scipy_distribution anymore it does not work"
        )
        includes = [
            [],
            ["z", "sv"],
        ...
        Stochastic = hddm.likelihoods.generate_wfpt_stochastic_class(
