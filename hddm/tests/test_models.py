...
class TestSingleBreakdown(unittest.TestCase):
    ...
    def test_HDDMStimCoding(self):
        ...
        m.sample(self.iter, burn=self.burn)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c0)']['node'].parents['v'], pm.Normal)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'], pm.PyMCObjects.Deterministic)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'].parents['self'], pm.Normal)

        m = hddm.HDDMStimCoding(data, stim_col='condition', split_param='z')
        m.sample(self.iter, burn=self.burn)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c0)']['node'].parents['z'], pm.CommonDeterministics.InvLogit)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['z'], pm.PyMCObjects.Deterministic)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['z'].parents['a'], int)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['z'].parents['b'], pm.CommonDeterministics.InvLogit)
        ...
        self.assertEqual(m.nodes_db.ix['wfpt(c0)']['node'].parents['v'].parents['a'].__name__, 'v')
        self.assertEqual(m.nodes_db.ix['wfpt(c0)']['node'].parents['v'].parents['b'].__name__, 'dc')
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'], pm.PyMCObjects.Deterministic)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'].parents['a'], pm.PyMCObjects.Deterministic)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'].parents['b'], pm.Normal)
        self.assertIsInstance(m.nodes_db.ix['wfpt(c1)']['node'].parents['v'].parents['a'].parents['self'], pm.Normal)
