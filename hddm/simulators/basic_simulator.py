...
model_config = {'ddm': {'params':['v', 'a', 'z', 't'],
                ...
                'ddm_sdv':{'params':['v', 'a', 'z', 't', 'sv'],
                           ...
                           'hddm_include': ['z', 'sv'],
                           'n_choices': 2},
                'ddm_par2':{'params': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 't'],
                            'param_bounds': [[-2.0, -2.0, -2.0, 0.3, 0.2, 0.2, 0.2, 0.0], [2.0, 2.0, 2.0, 2.0, 0.8, 0.8, 0.8, 2.0]],
                            'param_bounds_cnn': [[-2.5, -2.5, -2.5, 0.2, 0.1, 0.1, 0.1, 0.0], [2.5, 2.5, 2.5, 2.0, 0.9, 0.9, 0.9, 2.0]],
                            'boundary': bf.constant,
                            'n_params': 8,
                            'default_params': [0.0, 0.0, 0.0, 1.0, 0.5, 0.5, 0.5, 1.0],
                            'hddm_include': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 't'],
                            'n_choices': 4},
                'ddm_seq2':{'params': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 't'],
                            'param_bounds': [[-2.0, -2.0, -2.0, 0.3, 0.2, 0.2, 0.2, 0.0], [2.0, 2.0, 2.0, 2.0, 0.8, 0.8, 0.8, 2.0]],
                            'param_bounds_cnn': [[-2.5, -2.5, -2.5, 0.2, 0.1, 0.1, 0.1, 0.0], [2.5, 2.5, 2.5, 2.0, 0.9, 0.9, 0.9, 2.0]],
                            'boundary': bf.constant,
                            'n_params': 8,
                            ...
                            'hddm_include': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 't'],
                            'n_choices': 4},
                'ddm_mic2':{'params': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 'd', 't'],
                            'param_bounds': [[-2.0, -2.0, -2.0, 0.3, 0.2, 0.2, 0.2, 0.0, 0.0], [2.0, 2.0, 2.0, 2.0, 0.8, 0.8, 0.8, 1.0, 2.0]],
                            'param_bounds_cnn': [[-2.5, -2.5, -2.5, 0.2, 0.1, 0.1, 0.1, 0.0, 0.0], [2.5, 2.5, 2.5, 2.0, 0.9, 0.9, 0.9, 1.0, 2.0]],
                            'boundary': bf.constant,
                            'n_params': 9,
                            'default_params': [0.0, 0.0, 0.0, 1.0, 0.5, 0.5, 0.5, 0.5, 0.5],
                            'hddm_include': ['v_h', 'v_l_1', 'v_l_2', 'a', 'z_h', 'z_l_1', 'z_l_2', 'd', 't'],
                            'n_choices': 4},
                }
